...
Lr=1;
Lw=[1,2,3,3,4,6];
Ow=[4800,1500,1000,2000,800,4000];
Pw=[82.5,84,85,83,83.5,82.8];
%Pw=[84.0,84.5,83.2,83.5,82.8,82.5];   
Or=500;
BigM=[210,180,160,150,190,180];
qw=[0.945,0.970,0.975,0.945,0.955,0.950];   %Perfect Rate
qr=0.950;                              %Target Perfect Rate
